...
import { evaluateInputModeration } from './moderation';
import {
  extractCleanCampaignImageContext,
  constructGenerationPrompt,
} from './promptBuilder';
import { uploadGeneratedAssetToStorage } from './storage';
...
import { buildStructuredCampaignContext } from './contextBuilder';
...
import { aiAuditStore } from './aiAuditStore';
import {
  CalculationStatus,
  CostSummaryMetrics,
  PricingModelConfig,
...
// Normalization middleware for Vercel and reverse proxies:
// Ensures that if a proxy or rewrite strips /api, the path is normalized back to /api/...
